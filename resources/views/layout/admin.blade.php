	  ...
	  <div class="collapse navbar-collapse" id="navbarText">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item active">
	        <a class="nav-link active ml-5" href="/dashboard/category">Kategori</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link active" href="/dashboard/product">Product</a>
	      </li>

	      <li class="nav-item">
	        <a class="nav-link active" href="/dashboard/order">Pesanan</a>
	      </li>
	    </ul>
